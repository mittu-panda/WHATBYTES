...
export default function ComparisonGraph() {
  ...
  useEffect(() => {
    ...
    // Draw tooltip for the highlighted point
    ctx.fillStyle = "#fff"
    ctx.strokeStyle = "#e5e7eb"
    ctx.lineWidth = 1
    ctx.beginPath()
    ctx.rect(highlightedX - 40, highlightedY - 50, 80, 40)
    ctx.fill()
    ctx.stroke()
    ...
    ctx.textAlign = "center"
    ctx.fillText("90", highlightedX, highlightedY - 30)

    ctx.fillStyle = "#6b7280"
    ctx.font = "10px sans-serif"
    ctx.fillText("numberOfStudent : 4", highlightedX, highlightedY - 15)
  }, [])
